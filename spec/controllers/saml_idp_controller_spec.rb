  ...
  describe 'GET #new' do
    context 'when user is signed in' do
      ...
      it 'processes SAML authentication request' do
        get :new, params: { SAMLRequest: valid_saml_request }
    ...
    context 'with invalid SAML request' do
      it 'handles invalid SAML request' do
        get :new, params: { SAMLRequest: 'clearly_invalid' }
  ...
  describe 'POST #create' do
    context 'when user is signed in' do
      ...
      it 'processes SAML authentication response' do
        post :create, params: { SAMLRequest: valid_saml_request }
    ...
    context 'with invalid SAML request' do
      it 'handles invalid SAML request' do
        post :create, params: { SAMLRequest: 'invalid' }
