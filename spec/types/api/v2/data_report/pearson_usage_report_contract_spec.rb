...
RSpec.describe Api::V2::DataReport::PearsonUsageReportContract do
  ...
  describe 'report_type validation' do
    ...
    it 'fails when report_type is not pearson_usage_report' do
      params = valid_params
  ...
  describe 'client scope validation' do
    ...
    it 'fails when project_ids is empty regardless of client' do
      params = valid_params(project_ids: [])
