...
RSpec.describe Api::V2::DataReport::SavilleUsageReportContract do
  ...
  describe 'report_type validation' do
    ...
    it 'fails when report_type is not saville_usage_report' do
      params = valid_params
  ...
  describe 'configuration validation' do
    ...
    it 'succeeds when project_ids is missing' do
      params = valid_params
  ...
  describe 'client scope validation' do
    ...
    it 'succeeds when project_ids is empty regardless of client' do
      params = valid_params(project_ids: [])
