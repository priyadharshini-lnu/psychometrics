...
RSpec.describe Api::V2::DevelopmentAction::Schema do
  let(:valid_params) do
    jsonapi_resource_request(
      'development_actions',
      { id: '100', name: 'Development Action Name', description: 'Description' },
  ...
  shared_examples 'create/update' do |method|
    it 'validate presence of attributes' do
      schema = Api::V2::DevelopmentAction::Schema.send(method).call(
