...
RSpec.describe Assessors::SubjectEvaluationsCount do
  ...
  it 'return evaluations count for subject' do
    ...
    expected_result = {}
    expected_result[subject1.id] = { completed: 2, in_progress: 1, not_started: 1, interrupted: 0, total: 4 }
    expected_result[subject2.id] = { completed: 1, in_progress: 0, not_started: 1, interrupted: 0, total: 2 }
