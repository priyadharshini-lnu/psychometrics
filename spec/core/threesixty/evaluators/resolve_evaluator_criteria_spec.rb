...
describe Threesixty::Evaluators::ResolveEvaluatorCriteria do
  ...
  describe '.call check conditions' do
    before do
      create(:sheet_row, sheet: datasheet, email: user.email, data: { 'Age' => 21, 'No.' => 1 })
      create(:sheet_row, sheet: datasheet, email: subject.email, data: { 'Age' => 21, 'No.' => 2 })
  ...
  describe '.call check falsy condition' do
    before do
      create(:sheet_row, sheet: datasheet, email: user.email, data: { 'Age' => 21, 'No.' => 1 })
      create(:sheet_row, sheet: datasheet, email: subject.email, data: { 'Age' => 20, 'No.' => 2 })
