  ...
  describe '.call' do
    describe 'check without user' do
      ...
      it 'should returns a new participant' do
        expect(described_class.call(threesixty_campaign: campaign, subject: subject, params: @params, nominator: user)).to have_key(:ok)
      end
      ...
      it 'should create participants with unexisted and existed users' do
        ...
        participant2 = described_class.
                       call!(threesixty_campaign: campaign, subject: subject, params: { evaluator_email: user.email, relationship_id: peer.id },
    ...
    describe 'check with existed user' do
      ...
      it 'should create a new evaluator and participation' do
        ...
        described_class.call!(threesixty_campaign: campaign, subject: subject, params: @params, nominator: user, evaluator: user)
