...
describe Threesixty::ParticipatableByCriteria::ByUserFields do
  let(:threesixty_campaign) { create(:threesixty_campaign) }

  it 'filters participatable by name_or_email' do
  ...
  it 'filters participatable by first_name' do
  ...
  it 'filters participatable by last_name' do
  ...
  it 'filters participatables by not equals comparator' do
    subject_with_matching_last_name = create(:threesixty_subject, user: create(:user, last_name: 'Smith'))
    subject_without_matching_last_name = create(:threesixty_subject, user: create(:user, last_name: 'Cole'))
  ...
  it 'filters participatable by mutiple user fields' do
    ...
    participatables = [subject_with_matching_details, subject_with_partial_match, subject_without_matching_details]
    criteria_list = [
