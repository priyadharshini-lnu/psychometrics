...
describe Threesixty::Subjects::GetEvaluationsReceived do
  ...
  it 'returns total evaluations completed by user' do
    2.times do
      participant = create(:participant, campaign: threesixty_campaign.campaign, subject_id: threesixty_subjects[0].user_id)
      create(
        :users_result,
    ...
    participant = create(:participant, campaign: threesixty_campaign.campaign, subject_id: threesixty_subjects[1].user_id)
    create(
      :users_result,
      campaign: threesixty_campaign.campaign,
