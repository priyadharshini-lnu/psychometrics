...
describe Threesixty::PipedText::Branches::SubjectSmartTextFields::SecondPersonReflexive do
  describe '.call' do
    ...
    it do
      response = described_class.call!(%w[SecondPersonReflexive], {}, subject: subject, evaluator: subject)
      expect(response).to eq('Yourself')
    end
  end
end
