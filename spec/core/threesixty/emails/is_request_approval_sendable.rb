...
describe Threesixty::Emails::IsRequestApprovalSendable do
    ...
    it do
      create(:threesixty_option,
        ...
        "participants" => {
          ...
          "manager" => { "can_approve_nominations" => true, "subjects_can_email_managers" => true }
        }
      )
  ...
  describe 'invalid threesixty options for email' do
    ...
    it do
      create(:threesixty_option,
        ...
        "participants" => {
          "subject" =>  { "can_nominate_evaluators" => true },
          "manager" => { "can_approve_nominations" => false, "subjects_can_email_managers" => true }
        }
      )
