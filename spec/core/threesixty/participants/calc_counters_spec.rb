...
describe Threesixty::Participants::CalcCounters do
  ...
  describe 'manager should approve evaluations' do
    ...
    before do
      ...
      create(:threesixty_participant, campaign: campaign, subject_id: subject_1.user_id, manager_nomination_status: :approved, manager_evaluation_status: :approved)
      create(:threesixty_participant, subject_id: subject_1.user_id, manager_nomination_status: :approved, manager_evaluation_status: :approved)
      create(:threesixty_participant, campaign: campaign, subject_id: subject_2.user_id, manager_nomination_status: :approved, manager_evaluation_status: :approved)
      create(:threesixty_participant, campaign: campaign, evaluator_id: subject_2.user_id, manager_nomination_status: :approved, manager_evaluation_status: :approved)
      create(:threesixty_participant, campaign: campaign, evaluator_id: subject_1.user_id, manager_nomination_status: :waiting)
      create(:threesixty_participant, campaign: campaign, subject_id: subject_1.user_id, manager_nomination_status: :waiting)
    end
  ...
  describe 'manager should not approve evaluations' do
    ...
    before do
      ...
      create(:threesixty_participant, campaign: campaign, subject_id: subject_2.user_id, manager_nomination_status: :approved)
      create(:threesixty_participant, campaign: campaign, evaluator_id: subject_2.user_id, manager_nomination_status: :approved)
      create(:threesixty_participant, campaign: campaign, evaluator_id: subject_1.user_id, manager_nomination_status: :waiting)
      create(:threesixty_participant, campaign: campaign, subject_id: subject_1.user_id, manager_nomination_status: :waiting)
