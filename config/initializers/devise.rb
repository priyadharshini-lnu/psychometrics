...
Devise.setup do |config|
  ...
  config.mailer_sender = "no-reply@#{Settings.domain}"
  ...
  # config.pepper = '9c16a1b5e59509e95c7826069f9bca41b6491fcf14d0d2b0494d1e44185e575b139341af210aac7ce479902e106d9deb52
  # 5be8ff0cf1876a30b299554523072c'
  ...
  config.timeout_in = Rails.env.development? ? 30.days : 2.hours
  ...
  config.direct_otp_valid_for = 1.hour # Time before direct OTP becomes invalid
