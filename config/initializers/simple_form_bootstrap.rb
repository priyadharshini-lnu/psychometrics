...
SimpleForm.setup do |config|
  ...
  config.wrappers :administration_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'col-md-3 col-xs-12 control-label'

    b.wrapper tag: 'div', class: 'col-md-6 col-xs-12' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block text-danger' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
  ...
  config.wrappers :registration_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'col-md-12 col-xs-12 control-label'

    b.wrapper tag: 'div', class: 'col-md-12 col-xs-12' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block text-danger' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
