...
Rails.application.config.assets.precompile += %w(psychometrics_vendor.css psychometrics_pass_assessment.css psychometrics_pass_assessment.js)
Rails.application.config.assets.precompile += %w(psychometrics_reports_vendor.js psychometrics_reports_preview.js psychometrics_reports_threesixty_report.js psychometrics_reports_app.js)
Rails.application.config.assets.precompile += %w(psychometrics_reports_vendor.css psychometrics_reports_preview.css psychometrics_reports_threesixty_report.css psychometrics_reports_app.scss)
