...
export const fetchNomination = ({ campaignId, id }) => ({
  type: FETCH,
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${id}`,
  },
})
...
export const removeNomination = ({ campaignId, nominationId, evaluator }) => ({
  ...
  evaluator,
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/evaluators/${evaluator.evaluator.id}`,
    method: 'delete',
  },
})
...
export const addNomination = ({
  ...
  type: ADD,
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/evaluators`,
    method: 'post',
    body: {
      relationshipId,
      evaluatorEmail,
...
export const updateStatus = ({
  ...
  type: UPDATE_STATUS,
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/evaluators/${evaluatorId}/update_status`,
    method: 'put',
    body: {
      status,
    },
...
export const requestApproval = (campaignId, nominationId) => ({
  ...
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/request_approval`,
    method: 'get',
  },
})
...
export const sendEvaluatorReminder = (campaignId, nominationId) => ({
  ...
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/send_evaluator_reminders`,
    method: 'get',
  },
})
...
export const updateAllNominationStatus = (campaignId, nominationId, status) => ({
  ...
  request: {
    url: `/threesixty_campaigns/${campaignId}/nominations/${nominationId}/update_status`,
    method: 'put',
    body: { status },
  },
})
