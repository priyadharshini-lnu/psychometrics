...
import {
  Tabs, Layout, Row, Col, Space, Typography, Skeleton,
} from 'antd'
import { CalendarOutlined } from '@ant-design/icons'
import { connect, ConnectedProps } from 'react-redux'

import { DetailsCard, PageHeader as GlintPageHeader, FullWidthSkeleton } from '~/glint'
...
export const BookingsComponent:FC<PropsFromRedux> = ({
  ...
  const tabItems = [
    {
      ...
      />,
      key: 'invites',
      children: <InvitesList invites={invites} loading={invitesLoading} />,
    },
    {
      label: <TabLabel
...
const InvitesList: FC<InvitesListProps> = ({ invites, loading }) => (
  <Row gutter={[0, 12]}>
...
export const Bookings = connector(BookingsComponent)
