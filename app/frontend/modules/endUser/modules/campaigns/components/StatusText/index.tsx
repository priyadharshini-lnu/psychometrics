...
const STATUSES = {
  ...
  cancelled: { label: I18n.t('workshop_invited_subjects.statuses.cancelled'), textType: 'secondary' },
  requested_cancellation: {
    label: I18n.t('workshop_invited_subjects.statuses.requested_cancellation'),
    textType: 'secondary',
  },
  requested_rescheduling: {
    label: I18n.t('workshop_invited_subjects.statuses.requested_rescheduling'),
    textType: 'secondary',
  },
}
