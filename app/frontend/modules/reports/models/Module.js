...
import {
  AGILE, HOGAN, MICROSITE, PSYCHOMETRIC, SAVILLE, LEAD_ASSESSOR_FORM,
...
_.extend(Module.prototype, {
  ...
  canShowDataSet (type, category) {
    if ([HOGAN, SAVILLE, PSYCHOMETRIC, MICROSITE, AGILE, LEAD_ASSESSOR_FORM].includes(category)) { return true }
