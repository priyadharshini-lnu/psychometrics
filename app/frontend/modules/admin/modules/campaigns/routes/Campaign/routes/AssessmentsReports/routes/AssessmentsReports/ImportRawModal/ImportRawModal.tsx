...
interface Props {
  ...
  importRawResults(campaignId: number, assessmentId: number, data: any): Promise<any>
  campaignId: number
...
const ImportRawModal: React.FC<Props> = ({
  close, importRawResults, campaignId, campaignAssessmentId, loading,
}) => {
      ...
      footer={[
        ...
        <Button
          ...
          onClick={() => {
            ...
            importRawResults(campaignId, campaignAssessmentId, data)
              .then(() => {
