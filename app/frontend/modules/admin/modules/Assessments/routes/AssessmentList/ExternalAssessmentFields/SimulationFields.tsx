  ...
  return (
    <>
      <Form.Item
        ...
        label={I18n.t('assessments.column.external_settings.simulation_assessment_name')}
        rules={[{ required: true }]}
      >
        <Select
          disabled={!!assessment}
