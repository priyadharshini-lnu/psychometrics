...
function getUatUsageLimitProps (type?: string) {
  if (type === 'proctoring') {
    return {
      label: I18n.t('licenses.uat_usage_limit_credits'),
      extra: I18n.t('licenses.uat_usage_limit_credits_hint'),
    }
  }

  return {
    label: I18n.t('licenses.uat_usage_limit_users'),
    extra: I18n.t('licenses.uat_usage_limit_users_hint'),
  }
}
...
export const LicenseFormModal: React.FC<Props> = ({ close, license }) => {
  ...
  return (
      ...
      transformValues={(values: LicenseFormValues) => (
        {
          ...
          uatUsageLimit: values.uatUsageLimit || 0,
        })
    ...
    >
      {({ form }) => {
        const uatUsageLimitProps = getUatUsageLimitProps(form.getFieldValue('type'))
        ...
        return (
          <>
            ...
            <Form.Item
              name="uatUsageLimit"
              label={uatUsageLimitProps.label}
              extra={uatUsageLimitProps.extra}
            >
