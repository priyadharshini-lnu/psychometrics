...
export const MhsFields: React.FC<{ form: FormInstance }> = ({ form }) => {
  const assessmentIds = Form.useWatch('assessmentIds', form)

  useEffect(() => {
    fetch({ apiConfig: { filter: { type_eq: 'mhs', assessment_ids_in: assessmentIds } } })
  }, [assessmentIds])
  ...
  return (
    <>
      <Form.Item
        ...
        label={I18n.t('admin.mhs_report_id')}
      >
        <Select
