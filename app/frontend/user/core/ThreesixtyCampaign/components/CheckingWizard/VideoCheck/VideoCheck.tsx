    ...
    <Col className={styles.container} lg={8} xs={24} sm={24}>
      <Card className={styles.card}>
        ...
        <CheckList
          className="mt24"
          dataSource={[
            { name: I18n.t('checking_wizard.video_check.access'), status: CheckListStatus.Done },
            { name: I18n.t('checking_wizard.video_check.face_detection'), status: CheckListStatus.Failed },
            { name: I18n.t('checking_wizard.video_check.ambient_light'), status: CheckListStatus.InProgress },
          ]}
        />
