...
export const CHANGE_FILTER = 'admin/CHANGE_FILTER'
export const CHANGE_PAGE = 'admin/CHANGE_PAGE'
export const REMOVE_FILTER = 'admin/REMOVE_FILTER'
export const CHANGE_SORT = 'admin/CHANGE_SORT'
export const SET_TABLE_CONFIG = 'admin/SET_TABLE_CONFIG'
