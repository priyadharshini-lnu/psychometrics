    ...
    def show
      respond_to do |format|
        ...
        format.json do
          ...
          subjects, manager_subjects = ::Threesixty::NominationsByUserQuery.new(@campaign, current_user)
          evaluations, manager_evaluations = ::Threesixty::EvaluationsByUserQuery.new(@campaign, current_user)
