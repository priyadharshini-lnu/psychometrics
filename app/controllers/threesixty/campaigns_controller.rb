    ...
    def show
      respond_to do |format|
        ...
        format.json do
          ...
          subjects, manager_subjects = ::Threesixty::NominationsByUser.new(@campaign, current_user)
          evaluations, manager_evaluations = ::Threesixty::EvaluationsByUser.new(@campaign, current_user)
