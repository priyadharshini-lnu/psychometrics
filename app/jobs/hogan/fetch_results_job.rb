...
module Hogan
  class FetchResultsJob < ApplicationJob
    ...
    retry_on ::Hogan::Exceptions::ReportNotFound, wait: ->(executions) { executions * 2.minutes }, attempts: 3
    ...
    def perform(user_result, credentials, project)
      ...
      Hogan::FetchResults.call(user_result, credentials, project) do
        on(:not_completed) { raise ::Hogan::Exceptions::ReportNotFound, 'Unable to fetch hogan report' }
