...
module Api
  module V2
    module Administration
      class JobRoleTranslationImportForm
        ...
        def validate_file_content
          ...
          begin
            ...
            errors.add(:base, I18n.t('administration.job_roles.translations.import.errors.invalid_csv_format',
                                     message: e.message))
          ensure
            file.rewind if file.respond_to?(:rewind)
          end
        ...
        def validate_headers(headers)
          ...
          if missing_fields.any?
            errors.add(:base, I18n.t('administration.job_roles.translations.import.errors.missing_columns',
        ...
        def validate_row_format(csv_data)
          ...
          csv_data.each_with_index do |row, index|
            ...
            unless parts.size == 2
              errors.add(:base, I18n.t('administration.job_roles.translations.import.errors.invalid_id_format',
            ...
            unless %w[Name Description].include?(field_type)
              errors.add(:base, I18n.t('administration.job_roles.translations.import.errors.invalid_field_type',
