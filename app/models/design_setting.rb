...
class DesignSetting < ApplicationRecord
  ...
  has_one_image_attachment :as_logo, variants: [:icon]
  has_one_image_attachment :as_background, variants: [:icon]
  has_one_image_attachment :as_secondary_logo, variants: [:icon]
