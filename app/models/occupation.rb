...
class Occupation < ApplicationRecord
  ...
  has_one_image_attached :as_alternative_icon, variants: [:icon]
  has_one_image_attached :as_indicative_roles_image, variants: [:icon]
  has_one_image_attached :as_key_career_tracks_image, variants: [:icon]
