    ...
    module Results
      class AssessmentSerializer < ActiveModel::Serializer
        ...
        def results
          ...
          raw_factors = instance_options[:rows].select do |row|
          ...
          {
            normed_factors: normed_factors.map { |f| Api::V1::Results::FactorSerializer.new(f).to_h },
            raw_factors: raw_factors.map { |f| Api::V1::Results::FactorSerializer.new(f).to_h },
