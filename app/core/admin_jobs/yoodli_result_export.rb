...
module AdminJobs
  class YoodliResultExport < BaseExportAssessment
    RESULT_HEADERS_DATA = %w[userId scoreGiven scoreMaximum gradingProgress].freeze
    ...
    def headers
      [
        ...
        'Relationship', 'Started At', 'Completed At', 'Status', 'Candidate Id', 'Score Given', 'Score Maximum',
        'Grading Progress'
      ]
    end
