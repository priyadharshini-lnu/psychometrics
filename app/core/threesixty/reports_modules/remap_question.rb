  ...
  module ReportsModules
    class RemapQuestion < BaseCommand
      ...
      def remap_single_question
        ...
        report.modules.where("reports_modules.props ->> 'questionsChoices' IS NOT NULL").each do |m|
        ...
        report.modules.where("reports_modules.props -> 'source' ->>  'id' IS NOT NULL").each do |m|
