...
module UserReports
  class Webhook
    private_attr_reader :user_report, :project, :webhook_id, :user_result, :pdf_locale

    def initialize(user_report, pdf_locale = nil, webhook_id = nil)
      @user_report = user_report
      @pdf_locale = pdf_locale
