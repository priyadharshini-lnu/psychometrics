...
class Pearson::StartAssessment < AsyncResponseRequest::AsyncRequestHandler
  ...
  def call
    ...
    if pearson_user_assessment&.url.present?
      async_response.response_data = pearson_user_assessment.url
      return broadcast :ok, async_response
    end
