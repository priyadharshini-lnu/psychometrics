...
class Iiht::StartAssessment < AsyncResponseRequest::AsyncRequestHandler
  ...
  def call
    ...
    if iiht_user_assessment&.url.present?
      async_response.response_data = iiht_user_assessment.url
      return broadcast :ok, async_response
    end
