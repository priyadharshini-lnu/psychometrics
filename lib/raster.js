...
const PDF_PAGE_HEIGHT_OVERFLOW_MARGIN = 6;
//
// Functions
//
...
(async () => {
    ...
    try {
        ...
        try {
            await page.pdf({
                path: args.output,
                width: `${parseInt(args.pageWidth,10)*0.265}mm`,
                height: `${(parseInt(args.pageHeight,10) + PDF_PAGE_HEIGHT_OVERFLOW_MARGIN)*0.265}mm`,
