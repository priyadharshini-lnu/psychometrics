    ...
    module TwoFactorAuthenticatable
      ...
      module ClassMethods
        ...
        ::Devise::Models.config(
          self,
          :max_login_attempts, :allowed_otp_drift_seconds, :otp_length,
      ...
      module InstanceMethodsOnActivation
        ...
        delegate :max_login_attempts, to: :class

        def totp_enabled?
          respond_to?(:otp_secret_key) && otp_secret_key
        end
